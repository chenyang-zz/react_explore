(function (global, factory) {
	...
	function createWorkInProcess(current, pendingProps) {
	...
	const scheduleMircoTask = typeof queueMicrotask === 'function'
	    ? queueMicrotask
	...
	function ChildReconciler(shouldTrackEffects) {
	    ...
	    function replaceSingleChild(fiber) {
	    ...
	    return function reconcileChildFibers(returnFiber, currentFiber, newChild) {
	        ...
	        if (typeof newChild === 'object' && newChild !== null) {
	            switch (newChild.$$typeof) {
	                case REACT_ELEMENT_TYPE:
	                    return replaceSingleChild(reconcileSingleElement(returnFiber, currentFiber, newChild));
	            }
	            // 多节点情况 ul > li * 2
	        ...
	        if (typeof newChild === 'string' || typeof newChild === 'number') {
	            return replaceSingleChild(reconcileSingleTextNode(returnFiber, currentFiber, newChild + ''));
	        }
	...
	function updateState() {
	    ...
	    if (pending !== null) {
	        ...
	        if (baseQueue !== null) {
	            const { memoizedState, baseQueue: newBaseQueue, baseState: newBaseState } = processUpdateQueue(baesState, baseQueue, renderLane);
	            hook.memoizedState = memoizedState;
	...
	function updateWorkInProgressHook() {
	    ...
	    if (nextCurrentHook === null) {
	        ...
	        // update h1 h2 h3 h4
	        throw new Error(`组件${currentlyRenderingFiber?.tag}本次执行时的Hook比上次执行时多`);
	    }
	...
	function commitPassiveEffect(fiber, root, type) {
	    ...
	    if (updateQueue !== null) {
	        if (updateQueue.lastEffect === null && true) {
	            console.error('当FCUpdateQueue存在 PassiveEffect flag， 不应该不存在effect');
	        }
	...
	function renderRoot(root, lane, shouldTimeSlice) {
	    ...
	    if (!shouldTimeSlice && workInProcess !== null && true) {
	...
	function workLoopConcurrent() {
	    while (workInProcess !== null && !scheduler.unstable_shouldYield()) {
	        performUnitOfWork(workInProcess);
	    }
	}
